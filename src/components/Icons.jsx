...
export function BurgerIcon({ className, ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2 12h20a1 1 0 0 1 1 1v2a4 4 0 0 1-4 4H5a4 4 0 0 1-4-4v-2a1 1 0 0 1 1-1zm1 4h18v-2H3v2zm8.5-12a7.5 7.5 0 0 0-7.46 7h14.92A7.5 7.5 0 0 0 11.5 4z" />
    </svg>
  )
}
...
export function RocketIcon({ className, ...props }) {
  return (
    ...
    >
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12c0 2.5 1.5 5 4.5 6.5C9.5 20 12 22 12 22s2-2.5 3.5-5.5c3-1.5 5.5-4 6.5-6.5.5-1.5.5-3.5-1-5S17.5 1.5 16.5 2C14 3 11.5 5.5 10 8.5" />
